...
const Demo = () => {
    ...
    const fetchItems = (search) => {
        ...
        client.getItems(searchValue).then((data) => {
            setLoading(false)
                        ...
                        <div className="container flex justify-center items-center mb-6">
                            <div className="relative w-full max-w-xs m-auto">
                                ...
                                <div className="absolute top-2 right-2">
                                    <button onClick={() => fetchItems(true)} className="h-10 w-20 text-white rounded bg-teal-500 hover:bg-teal-600">Search</button>
                                </div>
                            </div>
                        </div>
